        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('ez/member/'.$user->id) }}">
                        {{ csrf_field() }}
                        {{ method_field('put') }}
                        ...
                        <div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="lastname" value="{{ $user->lastname or old('lastname') }}" required autofocus>
